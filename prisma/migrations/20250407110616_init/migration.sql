...
CREATE TABLE "CourseBenefits" (
    ...
    CONSTRAINT "CourseBenefits_pkey" PRIMARY KEY ("courseId","benefitId")
);
...
-- AddForeignKey
ALTER TABLE "CourseBenefits" ADD CONSTRAINT "CourseBenefits_benefitId_fkey" FOREIGN KEY ("benefitId") REFERENCES "Benefit"("id") ON DELETE CASCADE ON UPDATE CASCADE;
